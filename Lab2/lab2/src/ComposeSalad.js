    ...
    return (
      <form onSubmit={this.handleSubmit}>
        <div className="container">
          <h5>Välj bas</h5>
          <div>
            <select ref={(ref) => this.firstSelect = ref} className="form-control" name="foundation" onChange={this.handleSelection}>
              <option hidden />
        ...
        <div className="container">
          ...
          <div className="form-group">
            <select ref={(ref) => this.secondSelect = ref} className="form-control" name="dressing" onChange={this.handleSelection}>
